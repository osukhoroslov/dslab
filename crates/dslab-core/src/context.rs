...
impl SimulationContext {
    ...
    ///
    /// The event source will be equal to [`Self::id()`]. See [`Self::emit_as()`] if you want to emit event on behalf
    ...
    ///
    /// This is a shorthand for [`Self::emit()`] with zero delay.
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    ///
    /// This is a shorthand for [`Self::emit()`] with event destination equals [`Self::id()`].
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    ///
    /// This is a shorthand for [`Self::emit()`] with event destination equals [`Self::id()`] and zero delay.
    ///
    /// # Examples
    ///
    /// ```rust
    ...
    ///
    /// This is an extended version of [`Self::emit()`] for special cases when the event should be emitted on behalf of
    /// another component.
    ///
    /// ```rust
    /// use std::cell::RefCell;
